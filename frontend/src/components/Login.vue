  ...
  export default {
    ...
    methods : {
      login () {
        ...
        googleUrl () {
          let url = 'https://accounts.google.com/o/oauth2/v2/auth?scope=email&response_type=token&client_id=31558147321-ul0v75i3jugkns030ihug743nol0be7o.apps.googleusercontent.com&redirect_uri=http://localhost:8080/token';
